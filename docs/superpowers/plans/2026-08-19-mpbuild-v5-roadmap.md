...
> 当前开工：P3 → `docs/superpowers/plans/2026-08-19-mpbuild-v5-p3-gold.md`
...
| P2 增量 | `2026-08-19-mpbuild-v5-p2-watch.md` | Watch 状态机 + `mpb dev` + 增量正确性用例 |
| P3 金样 | `2026-08-19-mpbuild-v5-p3-gold.md` | `example/demo` 语义对比 CI |
...
1. 工作在当前阶段分支（P3：`feat/v5-p3-gold`）的隔离 worktree，不直接改用户当前 checkout 的 master 工作区。
